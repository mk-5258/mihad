...
const textLayers: TextLayer[] = [
  { text: "MIHAD", top: "8%", fromX: "5%", toX: "-15%", opacity: 0.018, size: "clamp(6rem,16vw,14rem)" },
  { text: "EDIT", top: "22%", fromX: "-10%", toX: "12%", opacity: 0.015, size: "clamp(5rem,12vw,10rem)" },
  { text: "CREATE", top: "38%", fromX: "8%", toX: "-20%", opacity: 0.013, size: "clamp(5rem,13vw,11rem)" },
  { text: "YOUTUBE", top: "52%", fromX: "-8%", toX: "15%", opacity: 0.014, size: "clamp(4rem,10vw,9rem)" },
  { text: "DISCORD", top: "65%", fromX: "12%", toX: "-18%", opacity: 0.012, size: "clamp(4rem,11vw,9.5rem)" },
  { text: "INSTAGRAM", top: "78%", fromX: "-5%", toX: "10%", opacity: 0.013, size: "clamp(3.5rem,9vw,8rem)" },
  { text: "COMMUNITY", top: "90%", fromX: "6%", toX: "-12%", opacity: 0.011, size: "clamp(3rem,8vw,7rem)" },
];
