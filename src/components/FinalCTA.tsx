      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <motion.p
            ...
            className="font-body text-sm md:text-[15px] font-light leading-relaxed text-muted max-w-lg"
          >
        ...
        <motion.div
          ...
          className="w-full h-px bg-gradient-to-r from-slate/25 to-transparent mb-10"
            ...
            >
              <div className="flex items-baseline gap-4 md:gap-8">
                ...
                <div className="flex items-baseline gap-4">
                  <span
                    className={`font-heading text-[clamp(1.5rem,3.5vw,2.8rem)] font-semibold tracking-[-0.01em] text-off-white/80 transition-colors duration-500 ${link.accent}`}
                  >
                    {link.label}
                  </span>
